...
export default function VideoComponent() {
    ...
    return (
        ...
        >
            ...
            <button className='hidden group-hover:block absolute z-10 top-[50%] left-[42%] sm:left-[46%] lg:left-[48%] text-white hover:bg-stone-950 bg-black opacity-50 dark:opacity-60 p-3 rounded-full text-xs' onClick={handlePlayVideo}>
                {isPlaying ? <FaRegStopCircle size={40}/> : <FaPlayCircle size={40}/>}
            </button>
            <div className='relative w-full h-full'>
                <div className="absolute top-0 left-0 w-full h-full bg-black opacity-30 dark:opacity-60 p-5 z-0 flex items-end justify-start bg-cover">
                </div>
